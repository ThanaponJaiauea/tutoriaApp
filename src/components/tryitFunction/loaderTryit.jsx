...
export default function LoaderTryit() {
              ...
              <div className="relative w-[100%] h-[500px] bg-white">
                <nav
                  ...
                  <div className={`$ w-[90%] flex justify-center items-center`}>
                    <p className="text-white text-lg font-bold">Loader Page</p>
                  </div>
                ...
                <div className="h-full flex items-center justify-center bg-[#ffff]">
                  <svg
                    aria-hidden="true"
