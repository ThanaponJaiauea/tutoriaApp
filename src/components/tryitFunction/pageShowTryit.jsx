...
export default function PageShowTryit() {
              ...
              <div className="relative w-[100%] h-[500px] bg-white">
                <nav
                  className={`w-full h-[70px] ${
                    currentPage ? "bg-[#457BFF]" : "bg-red-600"
                  }  flex justify-center items-center`}>
                  <div className="w-[10%] flex justify-center items-center">
                    <button
                      className={`${currentPage ? "hidden" : ""}`}
                  ...
                  <div
                    className={`${
                      currentPage ? "" : "hidden"
                    } w-[90%] flex justify-center items-center`}>
                  ...
                  <div
                    ...
                    <p className="text-white text-lg font-bold">Next Page</p>
                  </div>
